                ...
                <Container >
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        <Nav
                            ...
                            navbarScroll
                        >
                            <Nav.Link as={NavLink} to="/courses" className=''>All Courses</Nav.Link>
                        ...
                        {user ? (
                            <Nav.Link as={NavLink} to='/my-account' className="btn btn-primary account">My Account</Nav.Link>
                        ) : (
                            <Nav.Link as={NavLink} to='/account/login' className="btn btn-primary account">Login</Nav.Link>
                        )}
                    </Navbar.Collapse>
                </Container>
            </Navbar>
